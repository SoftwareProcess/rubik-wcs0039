...
def locateMiddleEdge(cubeModel, colorOne, colorTwo, edgeName):
    ...
    if(checkEdge((cubeModel.front[1][2], cubeModel.right[1][0]), colorOne, colorTwo)):
        if(cubeModel.front[1][2] == cubeModel.front[1][1] and cubeModel.right[1][0] == cubeModel.right[1][1]):
            pass
        else:
    ...
    if(checkEdge((cubeModel.back[1][2], cubeModel.left[1][0]), colorOne, colorTwo)):
    ...
    if(checkEdge((cubeModel.left[1][2], cubeModel.front[1][0]), colorOne, colorTwo)):
        if(cubeModel.left[1][2] == cubeModel.left[1][1] and cubeModel.front[1][0] == cubeModel.front[1][1]):
            pass
        else:
            solution += leftFrontTrigger(cubeModel) + leftTrigger(cubeModel) + solveMiddleEdge(cubeModel, colorOne, colorTwo, edgeName)
...
def solveMiddleEdge(cubeModel, colorOne, colorTwo, edgeName):
    ...
    if(edgeName == 'back/left'):
        ...
        elif(cubeModel.back[0][1] == colorTwo and cubeModel.up[0][1] == colorOne):
            doubleRotate(cubeModel, 'U')
            solution += 'UU' + leftBackTrigger(cubeModel) + backLeftTrigger(cubeModel)
    if(edgeName == 'left/front'):
        while(checkEdge((cubeModel.left[0][1], cubeModel.up[1][0]), colorOne, colorTwo) == False):
            U(cubeModel)
            solution += 'U'
